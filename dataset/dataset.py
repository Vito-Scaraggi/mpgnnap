...
if __name__ == "__main__":
    ...
    if (not os.path.isfile('dataset/tensors_files/e_train.pt')) or (not os.path.isfile('dataset/tensors_files/n_train.pt')) or (not os.path.isfile('dataset/tensors_files/gt_train.pt')):
        ...
        torch.save(nodes_tensor, 'dataset/tensors_files/n_train.pt')
        torch.save(edges_tensor, 'dataset/tensors_files/e_train.pt')
        torch.save(ground_truth_tensor, 'dataset/tensors_files/gt_train.pt')

    else:
        n_tensor = torch.load('dataset/tensors_files/n_train.pt')
        e_tensor = torch.load('dataset/tensors_files/e_train.pt')
        gt_tensor = torch.load('dataset/tensors_files/gt_train.pt')